          ...
          <div className="header-top py-1">
            <div className="row align-items-center">
              <div className="col-md-6">
                <ul className="header-top-left pull-left">
                  ...
                  <li className="currency dropdown pr-2">
                    <span
                      className="dropdown-toggle"
                      id="dropdownMenu12"
                      data-toggle="dropdown"
              ...
              <div className="col-10 header-bottom-right">
                    ...
                    <div className="collapse navbar-collapse navbar-ex1-collapse">
                      <ul className="nav navbar-nav main-navigation">
                        <li className="main_cat dropdown active">
                          <a href="category_page.html">Grocery & Staples</a>
                                  ...
                                  <div className="dropdown-menu">
                                    <div className="dropdown-inner">
                                      <ul className="list-unstyled childs_2">
                                        <li className="active">
                                          <a href="category_page.html">Arhar</a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                          <a href="category_page.html">Moong</a>
                                        </li>
                                        <li>
                                          <a href="category_page.html"
                                            >Rajma & Chana</a
                                        ...
                                        <li>
                                          <a href="category_page.html">Urad</a>
                                        </li>
                                      </ul>
                                    </div>
                                  </div>
                                  ...
                                  <div className="dropdown-menu">
                                    <div className="dropdown-inner">
                                      <ul className="list-unstyled childs_2">
                                        ...
                                        <li>
                                          <a href="category_page.html">Poha</a>
                                        </li>
                                        <li>
                                          <a href="category_page.html"
                                            >Sonamasuri & Kolam</a
                        ...
                        <li className="main_cat dropdown">
                          <a href="src/assets/category_page.html"
                            >Personal Care</a
                          >
                        ...
                        <li className="main_cat dropdown">
                          <a href="category_page.html">Household Needs</a>
                          <div className="dropdown-menu megamenu column1">
                            <div className="dropdown-inner">
                              <ul className="list-unstyled childs_1">
                                {/* <!-- 2 Level Sub Categories START --> */}
                        ...
                        <li className="main_cat dropdown">
                          <a href="category_page.html">Breakfast & Dairy</a>
                          <div className="dropdown-menu megamenu column1">
                            <div className="dropdown-inner">
                              <ul className="list-unstyled childs_1">
                                {/* <!-- 2 Level Sub Categories START --> */}
                        ...
                        <li className="main_cat thumb">
                          <a href="category_page.html">Fruits store </a>
                          <div className="dropdown-menu">
                            <div className="dropdown-inner">
                              <img
                                src="#"
                ...
                <div className="shopcart">
                  <div id="cart" className="btn-block mt-40 mb-30">
                    ...
                    <a href="cart_page.html" className="cart_responsive btn"
                      ><span id="cart-text">My basket</span
                      ><span id="cart-total-res">0</span>
                    </a>
                  </div>
              ...
              <div className="icon-block">
                ...
                <div className="telephone_icon">
                  <a href="contact_us.html"
                    ><i className="fa fa-phone"></i>Contact</a
                  >
                </div>
              </div>
            </div>
